            ...
            <div class="col-12">
                <div class="card shadow-sm border-0 rounded-4">
                    ...
                    <div class="card-body mt-3">
                        <form method="GET" action="{{ route('diskonSupplier') }}" class="mb-4" id="filterForm">
                            <div class="row g-2">
                                <div class="col-md-8">
                                    <select name="kode_supplier" id="kode_supplier" class="form-select2 form-select-sm">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#formDiskonStarlaReguler').on('submit', function(e) {
                ...
                let formData = $(this).serialize() + '&kode_supplier=' + kode_supplier;
