            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="{{ route('storePO') }}" method="POST">
                        @csrf
                        <h4 class="text-start fw-bold mb-2 mt-3">Input Purchase Order</h4>
                        <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-12 mt-1">
                                                <input type="date" name="jatuh_tempo" value="{{ Date('Y-m-d') }}"
                                                    readonly class="form-control form-control-sm" placeholder="Jatuh Tempo">
                                            </div>
                                            <div class="col-md-12 mt-1">
                                            ...
                                            <div class="card shadow-sm bg-primary text-white p-3 h-100 rounded-3">
                                                <div class="d-flex align-items-center h-100">
                                                    ...
                                                    <div class="flex-grow-1 text-end">
                                                        <small class="text-light">Total PO</small>
    ...
    <script>
        $(document).ready(function() {
            ...
            function tambahKeKeranjang() {
                ...
                const lanjutTambah = (hargaFinal) => {
                    ...
                    $('#diskon_persen').val(formatRupiah(0));
            ...
            <tr data-index="${idx}">
                ...
                <td class="text-end totalRow">${formatRupiah(item.total)}</td>
                <td class="text-center">
                    <button type="button" class="btn btn-sm btn-danger btnHapus" title="Hapus">
        ...
        `);
            ...
            function syncKeranjang() {
                ...
                const biayaLain = parseRupiah($('input[name="potongan_claim"]').val());

                $('#totalPenjualanDisplay').text(formatRupiah(totalSemua));
                ...
                const grandTotal = totalSemua + pajakNominal - biayaLain;
