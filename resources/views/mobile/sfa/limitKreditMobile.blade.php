...
@section('header', 'Pengajuan Limit Kredit')
...
@section('content')
    <div class="px-3 py-3 text-white"
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="ms-3">
                <div class="fw-bold fs-5">Pengajuan Limit Kredit</div>
            ...
            border-{{ $item->status_global == 'disetujui' ? 'success' : ($item->status_global == 'ditolak' ? 'danger' : 'warning') }} mb-3">
                <div class="card-body small">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="mb-0 fw-bold text-primary">#{{ $item->id }} | {{ $item->dibuat_oleh }}</h6>
                        <span
                    ...
                    <div class="mt-1">
                        <div class="fw-bold">
                            ...
                            {{ $item->kode_pelanggan }} - {{ $item->nama_pelanggan }} - {{ $item->nama_wilayah }}
                        </div>
                        <small class="text-muted">{{ $item->alamat_toko }}</small><br>
                    </div>
                    ...
                    <div class="mt-1 d-flex justify-content-between align-items-center">
                        ...
                        <span
                            class="text-end fw-bold text-success">Rp{{ number_format($item->nilai_pengajuan, 0, ',', '.') }}</span>
                    </div>
                    ...
                    <div class="mt-3 d-flex gap-2">
                        <button type="button" class="btn btn-sm btn-outline-primary flex-fill btn-open-approval"
                            ...
                            data-nilai="{{ $item->nilai_pengajuan }}" data-pengaju="{{ $item->user_id }}"
    ...
    <!-- Modal Tambah Pengajuan Limit Kredit - Mobile Version -->
    <div class="modal fade" id="modalTambahPengajuan" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('storePengajuanLimitMobile') }}" method="POST" class="modal-content rounded-4">
                @csrf
                <div class="modal-header bg-primary text-white rounded-top">
                    <h5 class="modal-title" id="modalTambahLabel">
                        <i class="fa fa-plus-circle me-2"></i> Pengajuan Limit Kredit
                    </h5>
                ...
                <div class="modal-body px-3 py-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alasan" id="alasan" class="form-control form-control-sm" rows="3"
                            placeholder="Contoh: Tambahan limit karena penjualan naik"></textarea>
                    </div>
                    <input type="text" name="nilai_pengajuan" id="nilai_pengajuan" inputmode="numeric"
    ...
    <!-- Modal Approval Pengajuan Limit Kredit - Mobile Version -->
                ...
                <form method="POST" id="approvalForm">
                    ...
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title">
                            <i class="fa fa-check-circle me-2"></i> Approval Limit Kredit
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                    </div>
                    <div class="modal-body px-3">
                        <div class="mb-2">
                            ...
                            <div id="info-kode-pelanggan" class="text-muted small">-</div>
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Nilai Pengajuan:</label>
                            <div id="info-nilai-pengajuan" class="text-muted small">Rp 0</div>
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Riwayat Approval:</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Limit Per Supplier:</label>
                            <div id="container-limit-supplier">
                                <div class="row g-2 mb-2">
                                    <div class="col-8">
                                        <select name="supplier[]" class="form-select form-select-sm">
                                            <option value="">-- Pilih Supplier --</option>
                                            @foreach (DB::table('supplier')->where('status', '1')->orderBy('nama_supplier')->get() as $supplier)
                                    ...
                                    <div class="col-4">
                                        <input type="text" name="limit_supplier[]"
                                            ...
                                            inputmode="numeric" pattern="\d*" placeholder="Rp 0">
                                    </div>
                                    <div class="col-12">
                        ...
                        <div class="table-responsive mb-3" style="zoom:80%">
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody id="tabel-supplier-limit"></tbody>
                            </table>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Revisi Limit (Opsional)</label>
        ...
        $(function() {
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn-open-approval', function() {
                    ...
                    $('#approvalForm').attr('action', `approvePengajuanLimitMobile/${approvalId}`);
