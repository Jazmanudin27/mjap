                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div
                        ...
                        <h5 class="mb-0 fw-bold">
                            <i class="fa fa-box-open me-2"></i> Data Saldo Awal Bad Stok
                        </h5>
                        <a href="{{ route('createSaldoAwalBS') }}"
                            class="btn btn-light btn-sm text-primary fw-semibold d-flex align-items-center gap-2">
                            <i class="fa fa-plus-circle"></i> <span>Get Saldo Awal</span>
                        </a>
                    </div>
                    <div class="card-body mt-3">
                        <form method="GET" action="{{ route('viewSaldoAwalBS') }}" class="mb-3">
                            <div class="row g-2">
