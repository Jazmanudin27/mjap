            ...
            <form action="{{ route('updateReturPembelian', $retur->no_retur) }}" method="POST" id="formReturPembelian">
                    ...
                    <div class="row g-2">
                        <div class="col-md-3">
                            ...
                            <select name="jenis_retur" class="form-select form-select-sm" required>
                                <option value="PF" {{ $retur->jenis_retur == 'PF' ? 'selected' : '' }}>Potong Faktur</option>
                                <option value="GB" {{ $retur->jenis_retur == 'GB' ? 'selected' : '' }}>Ganti Barang</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <select name="kode_supplier" id="kode_supplier" class="form-select form-select-sm" required>
                                @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->kode_supplier }}" {{ $retur->kode_supplier == $supplier->kode_supplier ? 'selected' : '' }}>
                            ...
                            <select name="no_faktur" class="form-select form-select-sm" required>
                                @foreach ($fakturs as $faktur)
                                    <option value="{{ $faktur->no_faktur }}" {{ $retur->no_faktur == $faktur->no_faktur ? 'selected' : '' }}>
                                        {{ $faktur->no_faktur }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea name="keterangan" class="form-control form-control-sm"
                        rows="2">{{ $retur->keterangan }}</textarea>
                </div>
            ...
            $('#kode_supplier').on('change', function () {
                ...
                const assignSupplierData = () => {
                    ...
                    localStorage.setItem('lastSupplier', JSON.stringify({
                        kode_supplier, no_hp, ppnValue, alamat, tempo
                    }));
