        ...
        <div class="col-6">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fa fa-box"></i> Laporan Retur Penjualan</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('cetakLaporanReturPenjualan') }}" method="POST" target="_blank"
                        autocomplete="off">
                        @csrf
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <select name="jenis_laporan" class="form-select2 form-select-sm" required>
                                    <option value="rekap" {{ request('jenis_laporan') == 'rekap' ? 'selected' : '' }}>
                                        Format Rekap
                                    </option>
                                    <option value="detail" {{ request('jenis_laporan') == 'detail' ? 'selected' : '' }}>
