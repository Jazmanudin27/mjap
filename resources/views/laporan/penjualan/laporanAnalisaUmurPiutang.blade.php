    ...
    <div class="col-6">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fa fa-hourglass-half me-1"></i> Laporan Analisa Umur Piutang</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('cetakAnalisaUmurPiutang') }}" method="POST" autocomplete="off" target="_blank">
                    @csrf
