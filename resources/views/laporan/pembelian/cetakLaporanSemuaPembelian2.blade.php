...
@section('content')
    <table class="table table-bordered">
                ...
                @foreach ($d->detail as $i => $item)
                    <tr>
                        @if($i === 0)
                            ...
                            <td rowspan="{{ $rowspan }}">{{ $d->kode_supplier }}</td>
                        ...
                        @if($i === 0)
                            <td class="text-end" rowspan="{{ $rowspan }}">{{ rupiah($d->potongan) }}</td>
                            <td class="text-end" rowspan="{{ $rowspan }}">{{ rupiah($d->biaya_lain) }}</td>
        ...
        <tfoot>
            <tr>
                <td colspan="13" class="text-end fw-bold">TOTAL</td>
