    ...
    <div class="col-md-12">
        <div class="card shadow-sm">
            <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fa fa-undo"></i> Laporan Retur Pembelian</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('cetakLaporanReturPembelian') }}" method="POST" autocomplete="off"
                    target="_blank">
                    @csrf
                    ...
                    <div class="row text-center mt-4">
                        <div class="col-md-6 mb-2">
                            <button type="submit" name="cetak" class="btn btn-sm btn-warning w-100 py-1 text-dark">
