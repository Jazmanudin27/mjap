    ...
    <div class="col-md-12">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fa fa-credit-card"></i> Laporan Kartu Hutang</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('cetakKartuHutang') }}" method="POST" autocomplete="off" target="_blank">
                    @csrf
