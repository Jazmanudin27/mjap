...
@section('titlepage', 'Data Pengajuan Limmit Faktur')
...
@section('contents')
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0 rounded-4">
                    <div
                        ...
                        <h5 class="mb-0 fw-bold"><i class="fa fa-credit-card me-2"></i> Data Pengajuan Limit Faktur</h5>
                    ...
                    <div class="card-body mt-3">
                        <form method="GET" action="{{ route('viewPengajuanFaktur') }}" class="mb-4">
                            <div class="row g-2">
                                <div class="col-md-4">
                                ...
                                <tbody>
                                    @forelse ($pengajuan as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->alasan }}</td>
                                            <td class="text-end">{{ $item->jumlah_faktur }}
                                            </td>
    ...
    <div class="modal fade" id="modalTambahPengajuan" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <form action="{{ route('storePengajuanFaktur') }}" method="POST" class="modal-content">
                @csrf
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="modalTambahLabel">
                        <i class="fa fa-plus-circle me-2"></i> Form Pengajuan Limit Faktur
                    </h5>
                ...
                <form method="POST" id="approvalForm">
                    ...
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title">
                            <i class="fa fa-check-circle me-2"></i> Approval Pengajuan Limit Faktur
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                    </div>
                    <div class="modal-body px-4">
                        ...
                        <!-- Nilai Pengajuan -->
                        <div class="mb-2">
                            <label class="fw-semibold">Jumlah Faktur</label>
        ...
        $(function() {
            $(document).ready(function() {
                ...
                $(document).on('click', '.btn-open-approval', function() {
                    ...
                    $('#approvalForm').attr('action', `approvePengajuanFaktur/${approvalId}`);
